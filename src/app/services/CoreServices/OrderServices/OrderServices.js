...
export class OrderServices {
    ...
    static createNewOrder = (data) => {
        return useHttpModule().post(config.useApiPath.api.orderService.createOrder, data)
        // return Promise.resolve({
        //     data: {
        //         result: config.useResultStatus.SUCCESS,
        //         info: {
    ...
    static createOrderDetail = (data) => {
        return useHttpModule().post(config.useApiPath.api.orderService.addOrderDetail, data)
        // return Promise.resolve({
        //     data: {
        //         result: config.useResultStatus.SUCCESS,
        //         info: {
    ...
    static viewOrder = (data) => {
        ...
        return useHttpModule().post(config.useApiPath.api.orderService.trackOrder, data)
        // if (data.page == 1) {
        //     return Promise.resolve({
        //         data: {
        //             result: config.useResultStatus.SUCCESS,
